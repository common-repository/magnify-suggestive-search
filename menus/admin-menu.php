...
function mnssp_dashboard_page() { ?>
    ...
    <div class="wrap mnssp-templates-wrap">
        ...
        <div class="mnssp-header-border-bottom">
        </div>
        <div class="mnssp-templates-page-title">
            <h1><?php echo esc_html('WordPress Theme Bundle'); ?></h1>
            <p><?php echo esc_html('Get 100+ WordPress Themes Worth $4,999+ At Just $89'); ?></p>
            <p>
                <a href="<?php echo esc_url('https://www.themagnifico.net/products/wordpress-theme-bundle'); ?>" class="mnssp-bundle-button button" target="_blank"><?php echo esc_html('Buy Now'); ?><span class="dashicons dashicons-cart"></span>
                </a>
            </p>
        </div>
