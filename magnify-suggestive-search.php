<?php
/*
    Plugin Name: Magnify - Suggestive Search
    Plugin URI: 
...
define( 'MNSSP_VER', $plugin_data['Version'] );
...
function mnssp_enqueue_admin_styles($hook) {
    ...
    if ( $hook != 'advanced-search_page_mnssp_guide_search_bar' ) {
        ...
        wp_add_inline_style('mnssp-global-styles', $custom_css);
    ...
    if (strpos($hook, 'advanced-search_page') === false && $hook != 'toplevel_page_mnssp_dashboard' && $hook != 'advanced-search_page_mnssp_guide_search_bar') {
        return;
    }
